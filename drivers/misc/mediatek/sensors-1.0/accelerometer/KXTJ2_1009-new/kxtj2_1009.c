...
/*----------------------------------------------------------------------------*/
//static struct i2c_board_info __initdata i2c_kxtj2_1009={ I2C_BOARD_INFO(KXTJ2_1009_DEV_NAME, (KXTJ2_1009_I2C_SLAVE_ADDR>>1))};//nik-kst
...
{
//	struct kxtj2_1009_i2c_data* obj = obj_i2c_data;//nik-kst
	GSE_FUN();
//	i2c_register_board_info(obj->hw.i2c_num, &i2c_kxtj2_1009, 1);//nik-kst
